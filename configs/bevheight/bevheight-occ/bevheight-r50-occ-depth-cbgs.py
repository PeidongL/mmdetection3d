...
train_pipeline = [
    dict(
        ...
        is_train=True,
        data_config=data_config),
    #TODO: dict(type='LoadOccGTFromFile',data_root=occ_gt_data_root),
    dict(
    ...
    #TODO: replace 'gt_bboxes_3d', 'gt_labels_3d' by 'voxel_semantics','mask_lidar','mask_camera'
    dict(
