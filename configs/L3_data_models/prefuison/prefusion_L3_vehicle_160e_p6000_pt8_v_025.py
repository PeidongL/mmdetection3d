...
l3_data_root = '/mnt/intel/jupyterhub/mrb/datasets/L4E_extracted_data_1227/L4E_origin_data/'
l3_benchmark_root = '/mnt/intel/jupyterhub/mrb/datasets/L4E_extracted_data_1227/L4E_origin_benchmark/'
...
data = dict(
    ...
    test=dict(
        ...
        ann_file=l3_benchmark_root + 'Kitti_L4_lc_data_mm3d_infos_val_5585_0119.pkl',
        split='training',
        pts_prefix='pointcloud',
        samples_per_gpu=8,
        pipeline=test_pipeline,
